...
namespace Unispect.SDK.Models
{
    ...
    public class UnispectResult
    {
        ...
        /// </summary>
        public List<TypeDefWrapper> TypeDefinitions { get; set; } = new List<TypeDefWrapper>();
        ...
        /// </summary>
        public static UnispectResult CreateSuccess(List<TypeDefWrapper> typeDefinitions, string processName, string moduleName, string memoryProxyType, TimeSpan duration)
        {
            return new UnispectResult
            {
                Success = true,
                TypeDefinitions = typeDefinitions ?? new List<TypeDefWrapper>(),
